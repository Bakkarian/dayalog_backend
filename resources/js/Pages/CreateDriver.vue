                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        <div class="sm:col-span-5">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Full Name
                                *</label>
                            <div class="mt-2">
                                <input type="text" name="full-name" id="full-name" required
                                       placeholder="Driver's Full Name" autocomplete="full-name"
                        ...
                        <div class="sm:col-span-5">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Patasente
                                Merchant Code *</label>
                            <div class="mt-2">
                                <input type="text" name="merchant-code" id="merchant-code" required
                                       placeholder="Merchant Code" autocomplete="merchant-code"
                                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                            </div>
                        </div>
                        <div class="sm:col-span-5">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Phone
                                Number *</label>
                            <div class="mt-2">
                                <input type="tel" name="phone number" id="phone" required
                                       placeholder="Driver's Phone Number" autocomplete="phone"
                                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                            </div>
                        </div>
                        <div class="sm:col-span-5">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Drivers
                                Licence Number *</label>
                            <div class="mt-2">
                                <input type="text" name="licence-number" id="phone" required
                                       placeholder="Drivers Licence Number" autocomplete="licence-number"
                                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                            </div>
                        </div>
                        <div class="sm:col-span-5">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Password
                                *</label>
                            <div class="mt-2">
                                <input type="text" name="password" id="password" placeholder="Merchant Code"
