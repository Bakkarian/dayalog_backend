<template>
    <div class="px-4 py-4 sm:px-6 lg:px-8 lg:py-6 max-w-7xl">
        <a href="/create-order" class="relative block max-w-[240px] rounded-lg border-2 border-dashed border-gray-300 p-4 text-center hover:border-gray-400">
