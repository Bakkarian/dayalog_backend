  ...
  <div class="bg-white sm:rounded-md">
    <ul role="list" class="divide-y divide-gray-200">
      <li v-for="driver in drivers" :key="driver.id">
        ...
        <div :class="driver.detailOpened?'h-[420px]':'h-0'" class="overflow-hidden bg-gray-50 transition-all ease-in-out duration-300">
          <div class="p-3 flex items-center border-b border-t">
            <div class="animate__animated" :class="driver.detailOpened?'animate__fadeInRight':'animate__fadeOutUp'">
              <button @click="driver.detailOpened = !driver.detailOpened" type="button" class="rounded-full bg-white border p-1 text-gray-500 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                <ArrowLeftIcon class="h-5 w-5" aria-hidden="true" />
              </button>
            </div>
            <h5 class="text-md font-bold ml-4 animate__animated animate__delay-0.3s" :class="driver.detailOpened?'animate__fadeInRight':'animate__fadeOutUp'">{{driver.name}}</h5>
          </div>
          <ul role="list" class="space-y-6 p-3 overflow-hidden">
            <li class="relative flex gap-x-4">
              ...
              <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500"><span class="font-medium text-gray-900">{{driver.from}}</span> Pickup Point.</p>
              <time datetime="2023-01-23T10:32" class="flex-none py-0.5 text-xs leading-5 text-gray-500">{{driver.setOffTime}}</time>
            </li>
            ...
            <li class="relative flex gap-x-4">
              ...
              <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500"><span class="font-medium text-gray-900">Kampala, Nansana</span> Final Delivery Point.</p>
